...
# main_folder = r'd/Projects/renaming-files-with-python'
main_folder = r'/mnt/d/Projects/renaming-files-with-python/files-to-change'
...
def file_loop(root, dirs, files):
    for file in files:
        ...
        print(f'Alterando o nome do arquivo \'{file}\' para \'{new_file_name}\'')
